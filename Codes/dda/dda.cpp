...
glFlush();
} //process all OpenGL functions as quickly as possible }
...
{ setPixel(xc + circPoint.getx () , yc + circPoint.gety ()); setPixel(xc - circPoint.getx () , yc + circPoint.gety ()); setPixel(xc + circPoint.getx () , yc - circPoint.gety ());
setPixel(xc - circPoint.getx () , yc - circPoint.gety ()); setPixel(xc + circPoint.gety () , yc + circPoint.getx ()); setPixel(xc - circPoint.gety () , yc + circPoint.getx ()); setPixel(xc + circPoint.gety () , yc - circPoint.getx ()); setPixel(xc - circPoint.gety () , yc - circPoint.getx ());
}
void display()
{
glClear(GL_COLOR_BUFFER_BIT); glColor3f(0.0,0.0,1.0); glPointSize(3.0); GLint xCenter=150;
GLint yCenter=150;
